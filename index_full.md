...
- **Skills**: **Python, Git, Docker, Linux, Bash**, AWS EC2, AWS S3, AWS Opensearch, Streamlit, LLM, LLM Agents, Langchain, Langgraph, Langsmith, RAG, Ragas, GPT, Claude, Bash, LLM
...
- **Skills**: **Python, API, ML Ops, Docker, Kubernetes, Kanban, Scrum, Linux, FastAPI, SQL**, ML Flow, Azure ML, Scikit Learn
...
- **Skills**: Migration to Azure Cloud, **Powershell Programming**

`2019-2023` <span style="font-size:1.2em;">**System Engineer / Developer**</span>, Kasterlinden
...
- **Skills**: **Django, Python, Git, Docker, SQL, Cloud Migration, Azure Cloud, Selenium, Networking: (DHCP, DNS, Exchange, Firewall), Powershell Programming, HTML, CSS**, Azure Cloud
...
- **Skills**: **Networking: (DHCP, DNS, Exchange, Firewall), PowerShell Programming, Confluence**
...
`2009-2010` <span style="font-size:1.2em;">**System Engineer / Development**</span>, University Ghent
...
- **Skills** : **Web Development (.NET), SQL, HTML, CSS, Networking: (DHCP, DNS, Exchange, Firewall)**
